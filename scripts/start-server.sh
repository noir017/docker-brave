...
# cd ${DATA_DIR}
# /usr/bin/chromium --user-data-dir=${DATA_DIR} --disable-accelerated-video --disable-gpu --window-size=${CUSTOM_RES_W},${CUSTOM_RES_H} --window-position=0,0 --no-sandbox --test-type --dbus-stub ${EXTRA_PARAMETERS} 2>/dev/null